    ...
    <body id="container">
        ...
        <div id="boddy">
            ...
            <ul>
                ...
                <li><a id="activeEdit" href="2.php">Bungalow in Kahawatta</a></li><br><br>
                <li><a id="editItem" href="3.php">Kadawala Bungalow</a></li><br><br>
            ...
            <div class="margin">
                ...
                Location : Kahawatta<br><br>

                The bungalow lies on a mountain top providing a panoramic view of the valley below to the coming visitors.<br> 
                It consist of several boxes which houses the bed rooms with side walls projected outwards linked with a concrete slab.<br>
                These are placed in different angles catching individual vistas of the valley beyond. 
            </div>
        </div>
