            ...
            <div class="row">
                ...
                <div class="col m2">
                    <div style="align:center;">
                        <h4><strong>My Projects</strong></h4><br>
                        <ul style="list-style: none;">
                        <?php
                        
                        $sql = "SELECT * from project WHERE customer_id='$cusid';";
                        $result = $conn->query($sql);

                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                echo '<li><a id="editItem" href="CustomerMyProject.php?id=' . $row["id"] . '">' . $row["title"] . '</a></li><br>';
