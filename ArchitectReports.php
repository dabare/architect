        ...
        <div style="margin-left:20%;padding:1px 16px;height:1000px;">
            ...
            <div id="border">
                ...
                <div style="margin-left: 60px;">
                    ...
                    <div style="display: inline-block">
                      <button class="btn btn-primary dropdown-toggle theme-l1 left-align" type="button"><i class="fa fa-circle-o-notch fa-fw margin-right"></i>Get Income Report 
                </button>
                    </div>
                </div><br><br><br>
                <div style="margin-left: 60px;">
                    ...
                    <div style="display: inline-block">
                      <button class="btn btn-primary dropdown-toggle theme-l1 left-align" type="button"><i class="fa fa-circle-o-notch fa-fw margin-right"></i>Get Expense Report
                </button> 
                    </div>
                </div><br><br><br>
                <div style="margin-left: 60px;">
                    ...
                    <div style="display: inline-block">
                      <button class="btn btn-primary dropdown-toggle theme-l1 left-align" type="button"><i class="fa fa-circle-o-notch fa-fw margin-right"></i>Total Profit
                </button>
                    </div>
                </div><br><br><br>
                <div style="margin-left: 60px;">
