...
<head>
    ...
    <title>Architect WebSite | Notifications</title>
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <?php
                            $sql = 'select  project.customer_id , project.id , project.priority as priority ,  project.title , project.city , project.category from post left join project on project.id = post.project_id where post.seen = 0 and project.architect_id = "'.$_SESSION["id"].'" and post.byy = "Client" and project.category="Industrial" ORDER BY priority DESC;';
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    if ($resultt->num_rows > 0) {
                                        while ($roww = $resultt->fetch_assoc()) {
                                            $cusName = $roww["lname"] . "_" . $roww["fname"];
                                        }
                                    }
                                    ...
                                    <a class="alert-link" href="ArchitectViewProject.php?id='.$row["id"].'">
                                        <button aria-hidden="true" data-dismiss="alert" class="close" type="button">×</button>
                                        <span class="label label-warning">' . $row["priority"] . '</span>
                                        '.$cusName.' Posted in '.$row["title"].' at '.$row["city"].'.</a>
                                    </div>
                                    ';
                                }
                            }
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content" style="height: 65vh;">
                        <div class="full-height-scroll" >
                        <?php
                            $sql = 'select  project.customer_id , project.id , project.priority as priority , project.title , project.city , project.category from post left join project on project.id = post.project_id where post.seen = 0 and project.architect_id = "'.$_SESSION["id"].'" and post.byy = "Client" and project.category="Residential" order by priority DESC;';
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content" style="height: 65vh;">
                        <div class="full-height-scroll" >
                        <?php
                            $sql = 'select  project.customer_id , project.id , project.title , project.priority as priority, project.city , project.category from post left join project on project.id = post.project_id where post.seen = 0 and project.architect_id = "'.$_SESSION["id"].'" and post.byy = "Client" and project.category="Community" order by priority DESC ;';
