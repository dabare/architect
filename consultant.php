        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper" class="gray-bg">
                ...
                <div class="row wrapper border-bottom white-bg page-heading">
                    ...
                    <div class="col-lg-1">
                        <br>
                        <a href="consultantReport.php" target="_blank">
                            ...
                            <div class="ibox">
                                <div class="ibox-content">
                                    ...
                                    <td>';
                                                    ...
                                                    $sql = "SELECT count(project.id) as count FROM consultant_assign left join project on  consultant_assign.project_id = project.id where project.status= 'Active' and consultant_assign.consultant_id = " . $row["id"] . ";";
                                    ...
                                    <td>';
                                                    ...
                                                    $sql = "SELECT project.id  as  id , project.category as category , project.title as title FROM consultant_assign left join project on  consultant_assign.project_id = project.id where project.status= 'Active' and consultant_assign.consultant_id = " . $row["id"] . ";";
                                                    $resultt = $conn->query($sql);
                                                    if ($resultt->num_rows > 0) {
                                                        while ($roww = $resultt->fetch_assoc()) {
