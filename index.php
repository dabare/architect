				...
				<div class="row">
					...
					<div class="col-md-4 wow fadeInLeft" data-wow-duration="500ms">
						<div class="service-item">
                            ...
                            SLIA Design Award 2011 - Award of merit under the category of Personalized housing for Subasinghe house at Kiribathgoda.<br><br></p>
							</div>
						</div>
					</div>
					<!-- end service item -->
						...
						<div class="service-item">
							...
							<div class="service-desc">
								...
								<p>B.Sc (Physical Science) University of Colombo - 1996<br><br>
                                    ...
                                    SLIA Part III<br>
                                    Sri Lanka Institute of Architects - 2004<br><br></p>
							</div>
						</div>
					</div>
					<!-- end service item -->
			...
			<div class="project-wrapper">
				...
				<figure class="mix work-item residential">
					...
					<figcaption class="overlay">
						<a class="fancybox" rel="works" title="Write Your Image Caption Here" href="img/res/pro3.jpg"><i class="fa fa-eye fa-lg"></i></a>
						<h4>Description</h4>
				...
				<figure class="mix work-item community">
					...
					<figcaption class="overlay">
						<a class="fancybox" rel="works" title="Write Your Image Caption Here" href="img/com/comm2.jpg"><i class="fa fa-eye fa-lg"></i></a>
						<h4>Description</h4>
					</figcaption>
				</figure>
				...
				<figure class="mix work-item industrial">
					...
					<figcaption class="overlay">
						<a class="fancybox" rel="works" title="Write Your Image Caption Here" href="img/indus/indus3.jpg"><i class="fa fa-eye fa-lg"></i></a>
						<h4>Description</h4>
					</figcaption>
				</figure>
				...
				<figure class="mix work-item residential">
					...
					<figcaption class="overlay">
						<a class="fancybox" rel="works" title="Write Your Image Caption Here" href="img/res/pro6.jpg"><i class="fa fa-eye fa-lg"></i></a>
						<h4>Description</h4>
					</figcaption>
				</figure>
				...
				<figure class="mix work-item community">
					...
					<figcaption class="overlay">
						<a class="fancybox" rel="works" title="Write Your Image Caption Here" href="img/com/comm3.jpg"><i class="fa fa-eye fa-lg"></i></a>
						<h4>Description</h4>
					</figcaption>
				</figure>
				...
				<figure class="mix work-item industrial">
					...
					<figcaption class="overlay">
						<a class="fancybox" rel="works" title="Write Your Image Caption Here" href="img/indus/indus7.jpg"><i class="fa fa-eye fa-lg"></i></a>
						<h4>Description</h4>
					</figcaption>
				</figure>
				...
				<figure class="mix work-item residential">
					...
					<figcaption class="overlay">
						<a class="fancybox" rel="works" title="Write Your Image Caption Here" href="img/res/pro9.jpg"><i class="fa fa-eye fa-lg"></i></a>
						<h4>Description</h4>
					</figcaption>
				</figure>
				...
				<figure class="mix work-item community">
					...
					<figcaption class="overlay">
						<a class="fancybox" rel="works" title="Write Your Image Caption Here" href="img/com/comm4.jpg"><i class="fa fa-eye fa-lg"></i></a>
						<h4>Description</h4>
					</figcaption>
				</figure>
