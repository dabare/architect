...
<script type="text/javascript">
    //validating signup form
        function testform(){
            ...
            if(document.register.psswd.value==''){
                alert("Please enter your Password!");
                return false;
            }
            if(document.register.cnfrmpsswd.value==''){
                alert("Please Retype your Password!");
                return false;
            }
            if(document.register.psswd.value!=document.register.cnfrmpsswd.value){
...
//validating fields in sigup form
        ...
        function validatepass(){
           ...
           var cpwd =  document.getElementById('cnfrmpsswd').value;
           
            if (pwd != cpwd) {

            document.getElementById('psswd').style.background ='#ff8989';
            document.getElementById('cnfrmpsswd').style.background = '#ff8989';
    ...
    <div id="wrapper">
        <div id="page-wrapper" class="gray-bg">            
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2><i>Consultant Registration</i></h2>                    
                </div>                
            </div>            
         <div class="wrapper wrapper-content animated fadeInRight ecommerce">
            <div class="row">
                <div class="ibox-content col-sm-10">
                <form enctype="multipart/form-data" name="register" method="post" action="Controllers/insertConsultant.php" onsubmit="return testform()" class="form-horizontal">
                    <div class="row">                    
                    ...
                    <div class="form-group"><label class="col-sm-2 control-label">Password:</label>
                        <div class="col-sm-9"><input type="password" name="psswd" required class="form-control" placeholder="Password" id="psswd">
                        </div>
                    </div>
                    <div class="form-group"><label class="col-sm-2 control-label">Retype Password:</label>
                        <div class="col-sm-9"><input type="password" required class="form-control" name="cnfrmpsswd" placeholder="Retype Password" id="cnfrmpsswd" onblur="validatepass();">
