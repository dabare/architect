                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content" style="height: 65vh;">
                        ...
                        <?php
                            ...
                            $sql = "SELECT CONCAT (customer.fname , '_', customer.lname ) AS det  , project.city AS city , project.progress as prog , project.title as title , project.id as id FROM project INNER JOIN customer ON project.customer_id=customer.id WHERE project.category='Industrial' AND project.progress=100 AND project.architect_id='1' AND project.status='Active' ORDER BY city ASC;";
                            $result = $conn->query($sql);
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content" style="height: 65vh;">
                        ...
                        <?php
                            ...
                            $sql = "SELECT CONCAT (customer.fname , '_', customer.lname ) AS det  , project.city AS city , project.progress as prog , project.title as title , project.id as id FROM project INNER JOIN customer ON project.customer_id=customer.id WHERE project.category='Residential' AND project.progress=100 AND project.architect_id='1' AND project.status='Active' ORDER BY city ASC;";
                            $result = $conn->query($sql);
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content" style="height: 65vh;">
                        ...
                        <?php
                            ...
                            $sql = "SELECT CONCAT (customer.fname , '_', customer.lname ) AS det  , project.city AS city , project.progress as prog , project.title as title , project.id as id FROM project INNER JOIN customer ON project.customer_id=customer.id WHERE project.category='Community' AND project.progress=100 AND project.architect_id='1' AND project.status='Active' ORDER BY city ASC;";
                            $result = $conn->query($sql);
