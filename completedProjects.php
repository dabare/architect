...
<html>
    ...
    <head>
        ...
        <title>Architect WebSite | Completed Projects</title>
            ...
            <div id="page-wrapper" class="gray-bg">
                ...
                <div class="row wrapper border-bottom white-bg page-heading">
                    ...
                    <div class="col-lg-5 pull-right">
                        ...
                        $search = $_GET["search"];
                        ?>
                        <form action="completedProjects.php" method="get">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="ibox float-e-margins">
                                <div class="ibox-title">
                                    <h5>Industrial</h5>
                                    <a href="completedProjectsReport.php?c=industrial" target="_blank">
                                ...
                                <div class="ibox-content" style="height: 65vh;">
                                    <div class="full-height-scroll" >
                                        <?php
                                        $sql = "SELECT CONCAT (customer.fname , '_', customer.lname ) AS det  , project.city AS city , project.progress as prog , project.title as title , project.id as id FROM project INNER JOIN customer ON project.customer_id=customer.id WHERE project.category='Industrial' AND project.progress=100 AND project.architect_id='1' AND project.status='Active' and (project.title like '%$search%' or project.city like '%$search%') ORDER BY city ASC;";
                                        $result = $conn->query($sql);
                        ...
                        <div class="col-lg-4">
                            <div class="ibox float-e-margins">
                                <div class="ibox-title">
                                    <h5>Residential</h5>
                                    <a href="completedProjectsReport.php?c=residential" target="_blank">
                                        <div class="col-sm-2 pull-right"><input required type="submit" class="btn btn-success btn-sm" value="Print">
                                        </div>
                                    </a>
                                </div>
                                ...
                                <div class="ibox-content" style="height: 65vh;">
                                    <div class="full-height-scroll" >
                                        <?php
                                        $sql = "SELECT CONCAT (customer.fname , '_', customer.lname ) AS det  , project.city AS city , project.progress as prog , project.title as title , project.id as id FROM project INNER JOIN customer ON project.customer_id=customer.id WHERE project.category='Residential' AND project.progress=100 AND project.architect_id='1' AND project.status='Active' and (project.title like '%$search%' or project.city like '%$search%') ORDER BY city ASC;";
                                        $result = $conn->query($sql);
                        ...
                        <div class="col-lg-4">
                            <div class="ibox float-e-margins">
                                <div class="ibox-title">
                                    <h5>Community</h5>
                                    <a href="completedProjectsReport.php?c=Community" target="_blank">
                                        <div class="col-sm-2 pull-right"><input required type="submit" class="btn btn-success btn-sm" value="Print">
                                        </div>
                                    </a>
                                </div>
                                ...
                                <div class="ibox-content" style="height: 65vh;">
                                    <div class="full-height-scroll" >
                                        <?php
                                        $sql = "SELECT CONCAT (customer.fname , '_', customer.lname ) AS det  , project.city AS city , project.progress as prog , project.title as title , project.id as id FROM project INNER JOIN customer ON project.customer_id=customer.id WHERE project.category='Community' AND project.progress=100 AND project.architect_id='1' AND project.status='Active' and (project.title like '%$search%' or project.city like '%$search%') ORDER BY city ASC;";
                                        $result = $conn->query($sql);
