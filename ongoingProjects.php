            ...
            <div id="page-wrapper" class="gray-bg">
                ...
                <div class="row wrapper border-bottom white-bg page-heading">
                    ...
                    <div class="col-lg-5 pull-right">
                        ...
                        $search = $_GET["search"];
                        ?>
                        <form action="ongoingProjects.php" method="get">
                            ...
                            <div class="ibox float-e-margins">
                                ...
                                <div class="ibox-content" style="height: 65vh;">
                                    <div class="full-height-scroll" >
                                        <?php
                                        $sql = "SELECT CONCAT (customer.fname , '_', customer.lname ) AS det , project.priority AS priority , project.city AS city , project.progress as prog , project.title as title , project.id as id FROM project INNER JOIN customer ON project.customer_id=customer.id WHERE project.category='Industrial' AND project.progress!=100 AND project.architect_id='1' AND project.status='Active' and (project.title like '%$search%' or project.city like '%$search%') ORDER BY priority DESC , city ASC;";
                                        $result = $conn->query($sql);
                            ...
                            <div class="ibox float-e-margins">
                                ...
                                <div class="ibox-content" style="height: 65vh;">
                                    <div class="full-height-scroll" >
                                        ...
                                        $sql = "SELECT CONCAT (customer.fname , '_', customer.lname ) AS det , project.priority as priority , project.city AS city , project.progress as prog , project.title as title , project.id as id FROM project INNER JOIN customer ON project.customer_id=customer.id WHERE project.category='Residential' AND project.progress!=100 AND project.architect_id='1' AND project.status='Active' and (project.title like '%$search%' or project.city like '%$search%') ORDER BY priority DESC ,city ASC;";
                                        $result = $conn->query($sql);
                            ...
                            <div class="ibox float-e-margins">
                                ...
                                <div class="ibox-content" style="height: 65vh;">
                                    <div class="full-height-scroll" >
                                        ...
                                        $sql = "SELECT CONCAT (customer.fname , '_', customer.lname ) AS det , project.priority as priority , project.city AS city , project.progress as prog , project.title as title , project.id as id FROM project INNER JOIN customer ON project.customer_id=customer.id WHERE project.category='Community' AND project.progress!=100 AND project.architect_id='1' AND project.status='Active' and (project.title like '%$search%' or project.city like '%$search%') ORDER BY priority DESC , city ASC;";
                                        $result = $conn->query($sql);
