                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <select class="form-control" id="category" name="category" required>
                                                                <option <?php if ($category == "Industrial") {
                            echo 'selected';
                        } ?> value="Industrial">Industrial</option>
                                                                <option <?php if ($category == "Community") {
                            echo 'selected';
                        } ?> value="Community">Community</option>
                                                                <option <?php if ($category == "Residential") {
                            echo 'selected';
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <div class="form-group"><label class="col-sm-3 control-label">Description:</label>
                                                        ...
                                                        <div class="col-sm-7"><textarea rows="5" name="description" required class="form-control"><?= $description ?></textarea>
                                                        </div>
                                                    </div>
                                ...
                                <center>
                                            <br><br>
                                            <button type="button"  class="btn btn-danger" onclick="deleteProject()">Delete This Project</button>
                                        </center>
                            </div>
                        </div>
