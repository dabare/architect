...
<div class="container content" style="max-width:1400px;margin-top:50px;margin-left: 10px">
	...
	<div class="row">
        ...
        <div style="margin-left: 700px;margin-top: -450px;">
            <a  href="newemployeeform.php"><button class="btn btn-primary dropdown-toggle theme-l1 left-align" type="button"><i class="fa fa-circle-o-notch fa-fw margin-right"></i>Add New
                </button></a>
        </div>
