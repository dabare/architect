                    ...
                    <div style="margin-left: 10px;">
                        <form>
                            <div style="text-align: left;margin-right: 50px;">
                                Contact No:<br>
                                <input type="text" name="date" size="20" value="<?php echo $land_no ?>" >
                            </div>
                            <br>
                            Email:
                            <br>
                                <input type="text" name="date" size="25" value="<?php echo $email ?>" >
                            <div><br>
                                Address:<br>
                            ...
                            <div>
                                Description:<br>
                                <textarea required="true" name="desc" rows="4" cols="50" style="position: left"><?php echo $description ?></textarea>
                            </div><br><br>
