                        ...
                        <center>
                            <div id="loginDiv" >
                                ...
                                <form action="loginAction.php" method="post">
                                    <br>
                                    <label for="uname">Username: </label><input id="uname" required="true" type="text" name="usrname"/>
                                    <br>
                                    <label for="uname">Password: </label><input required="true" type="password" name="pswrd"/>
                                    <br>
                                    <input type="submit" name="login" value="Login"/>
                                    <input type="reset" value="Cancel"/>
                                    <br>
                                    <a class="text-info" href="javascript:AlertIt();" target="_blank">Forgotten password?</a>
                                </form>
                                <script type="text/javascript">
                                    function AlertIt() {
                                        ...
                                        if (uname == "") {
                                            ...
                                            var answer = confirm("Send me an email")
                                            if (answer) {
                                                document.getElementById("email").value = uname;
                                                document.fogotPass.submit();
                                            }
                                        }

                                    }
                                </script>
                                <form name="fogotPass" action="fogotPassword.php" method="POST" >
