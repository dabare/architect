...
<div>
	...
	<div id="form">
	<form action=employeeattendence.php	method="post" name="employee" onsubmit="validation()">
		<table>
			...
			<tr><td><label for="employeename">Attendence days</label></td></tr>
			<tr><td><input type="number" name="attendence" required></td></tr>
			<tr><td><label for="employeename">Absent days</label></td></tr>
			<tr><td><input type="number" name="absent" required></td></tr>
