                ...
                <div style="margin-left:300px">
                    <div style="text-align: center">
                        ...
                        <div style="text-align: right;padding-right: 5%;">
                            <a  href="Projects/NewAwards.php"><button class="btn btn-primary dropdown-toggle theme-l1 left-align" type="button"><i class="fa fa-circle-o-notch fa-fw margin-right"></i>Add New
                                </button>
                        </div>
                        <br><br>
                        <div id="border">
                            ...
                            <form>
                                <fieldset style="background-color: transparent;width: 300px;height: 400px;margin-left: 50px;">
                                    <legend><h3>Awards</h3></legend>
                                    <ul style="list-style: outside">
                                        ...
                                        if ($result->num_rows > 0) {
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                             echo '<li><a id="editItem" href="ArchitectManageAwards1.php?id=' . $row["id"] . '">' . $row["title"] . '</a></li><br>';
                                            }
                                        }
                                        ?>
                                    </ul>
                        ...
                        <div id="border">
                            <form>
                                <fieldset style="background-color: transparent;width: 300px;height: 400px;margin-left: 500px;margin-top: -430px;">
                                    <legend><h3>Academic Qualifications</h3></legend><br>
                                    <ul style="list-style: outside">
                                        <?php
                                        ...
                                        if ($result1->num_rows > 0) {
                                            ...
                                            while ($row = $result1->fetch_assoc()) {
                                                echo '<li><a id="editItem" href="ArchitectManageAwards1.php?id=' . $row["id"] . '">' . $row["description"] . '</a></li><br>';
                                            }
                                        }
                                        ?>
                                    </ul>
